            ...
            {cartItems.length === 0 ? (
                ...
                <div className="bg-[#c47b59] shadow-md rounded-lg p-4">
                        ...
                        {cartItems.map((item) => (
                            ...
                            >
                                ...
                                <p className="font-semibold text-white">
                                    Ksh{cartItems.reduce((sum, item) => sum + parseFloat(item.price) * item.quantity, 0)}
                                </p>
                            </li>
                        ))}
                    </ul>
                    <div className="mt-6 flex justify-between text-lg font-semibold">
                        ...
                        <span className="text-white">Ksh{cartItems.reduce((sum, item) => sum + parseFloat(item.price) * item.quantity, 0)}</span>
                    </div>
                    <button
